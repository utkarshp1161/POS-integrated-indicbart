...
class Trainer:
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        if is_datasets_available() and isinstance(train_dataset, datasets.Dataset):
            ...
            ####### pos getting removed here?  print
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            step = -1
            #print("before--iterator-epoch")
            self.epoch_itr = epoch_iterator
            for step, inputs in enumerate(epoch_iterator):
                #print("reached--inside epoch iterator")
            ...
            # self.control values below  determine whether evaluation step will take place
        ...
        print("end of inner-training loop")

        return TrainOutput(self.state.global_step, train_loss, metrics)

    #### inner training loop ends
    ...
    def _maybe_log_save_evaluate(self, tr_loss, model, trial, epoch, ignore_keys_for_eval):
        ...
        metrics = None
        if self.control.should_evaluate: # true after epochs end
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if self.label_smoother is not None and "labels" in inputs:
            ...
            labels = None
        #print("inside_compute-loss")
        self.compute_loss_inputs = inputs # is a dictionary
    ...
    def evaluation_loop(
        ...
        if self.compute_metrics is not None and all_preds is not None and all_labels is not None:
            if args.include_inputs_for_metrics:
                ...
                #print("not-included metrics")
                self.eval_preds_all_labels = all_preds, all_labels
    ...
    def floating_point_ops(self, inputs: Dict[str, Union[torch.Tensor, Any]]):
        ...
        if hasattr(self.model, "floating_point_ops"):
            return 0#return self.model.floating_point_ops(inputs)
        else:
            return 0
    ...
    def prediction_loop(
        ...
        if self.compute_metrics is not None and preds is not None and label_ids is not None:
            if args.include_inputs_for_metrics: ##### false
